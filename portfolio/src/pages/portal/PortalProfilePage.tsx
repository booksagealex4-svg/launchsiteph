...
export function PortalProfilePage() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3 rounded-lg border border-[var(--card-border-accent)] bg-slate-50/60 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
