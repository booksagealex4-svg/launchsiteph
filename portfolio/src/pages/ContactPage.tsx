...
export function ContactPage() {
  return (
    <header className="relative overflow-hidden rounded-lg border border-slate-200/70 bg-[#fdfbf7] px-6 py-6 shadow-[0_1px_2px_rgba(15,23,42,0.03)] sm:px-8 sm:py-7">
