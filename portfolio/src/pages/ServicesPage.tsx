...
const mockupImage = {
  ...
  authorMilaHart: '/mockups/services/author-mila-hart.webp',
  ...
  webappDashboard02: '/mockups/services/webapp-dashboard-02.webp',
  webappClientManagement01: '/mockups/services/webapp-client-management-01.webp',
  webappClientManagement02: '/mockups/services/webapp-client-management-02.webp',
  ...
  webappInventory02: '/mockups/services/webapp-inventory-02.webp',
  ...
  trackerProject02: '/mockups/services/tracker-project-02.webp',
  trackerClientPortal01: '/mockups/services/tracker-client-portal-01.webp',
  trackerClientPortal02: '/mockups/services/tracker-client-portal-02.webp',
  trackerAuthorPortal01: '/mockups/services/tracker-author-portal-01.webp',
  trackerAuthorPortal02: '/mockups/services/tracker-author-portal-02.webp',
  trackerProgressDashboard01: '/mockups/services/tracker-progress-dashboard-01.webp',
  trackerProgressDashboard02: '/mockups/services/tracker-progress-dashboard-02.webp',
} as const
  ...
  [
    {
      ...
      images: [
        ...
        {
          src: mockupImage.authorOliveMeadow,
          alt: "Concept mockup for a children's picture-book author website with illustrated animal characters",
          previewTitle: "Children's Author Website Concept — Illustrated & Whimsical",
          previewType: 'Author / Books / Personal Brand',
        },
        {
          src: mockupImage.authorMilaHart,
          alt: "Concept mockup for a children's author website with a warm, personal photo-led layout",
          previewTitle: "Children's Author Website Concept — Warm & Personal",
          previewType: 'Author / Books / Personal Brand',
        },
        {
          src: mockupImage.authorEleanorGrant,
          alt: 'Concept mockup for a literary fiction author website with an elegant, editorial layout',
          previewTitle: 'Literary Fiction Author Website Concept',
          previewType: 'Author / Books / Personal Brand',
        },
      ],
    },
  ...
  [
    {
      ...
      images: [
        {
          src: mockupImage.webappDashboard01,
          alt: 'Concept mockup for a client management dashboard with growth charts and status overview',
          previewTitle: 'Dashboard Concept',
          previewType: 'Dashboard / Analytics / Workflow',
        },
        {
          src: mockupImage.webappDashboard02,
          alt: 'Concept mockup for a dashboard with a sales pipeline and invoice overview',
          previewTitle: 'Analytics Dashboard Concept',
          previewType: 'Dashboard / Analytics / Workflow',
        },
      ],
    },
    {
      ...
      images: [
        {
          src: mockupImage.webappClientManagement01,
          alt: 'Concept mockup for a client portal with project progress and activity',
          previewTitle: 'Client Management Concept',
          previewType: 'CRM / Leads / Client Management',
        },
        {
          src: mockupImage.webappClientManagement02,
          alt: 'Concept mockup for a client portal with messages, meetings, and invoices',
    ...
    },
    {
      ...
      images: [
        ...
        {
          src: mockupImage.webappBookingSystem01,
          alt: 'Concept mockup for a booking and scheduling platform landing page with a calendar and appointment widget',
          previewTitle: 'Scheduling Platform Concept',
          previewType: 'Scheduling / Appointments / Clients',
        },
        {
          src: mockupImage.webappBookingSystem02,
          alt: "Concept mockup for a booking system dashboard with today's schedule, calendar, and a quick booking form",
          previewTitle: 'Booking Dashboard Concept',
          previewType: 'Scheduling / Appointments / Clients',
        },
      ],
    },
    {
      ...
      images: [
        {
          src: mockupImage.webappInventory01,
          alt: 'Concept mockup for an inventory management platform landing page with a dashboard preview',
          previewTitle: 'Inventory Management Concept',
          previewType: 'Inventory / Stock / Warehouse',
        },
        {
          src: mockupImage.webappInventory02,
          alt: 'Concept mockup for an inventory dashboard with stock levels, recent products, and stock alerts',
          previewTitle: 'Stock Management Concept',
          previewType: 'Inventory / Stock / Warehouse',
        },
      ],
    },
    {
      ...
      images: [
        ...
        {
          src: mockupImage.webappMemberPortal01,
          alt: 'Concept mockup for a member dashboard with programs, progress, upcoming sessions, and community highlights',
          previewTitle: 'Member Dashboard Concept',
          previewType: 'Portal / Files / Communication',
        },
        {
          src: mockupImage.webappMemberPortal02,
          alt: 'Concept mockup for a member portal with course progress, resources, and billing information',
          previewTitle: 'Learning Portal Concept',
          previewType: 'Portal / Files / Communication',
        },
      ],
    },
    {
      ...
      images: [
        {
          src: mockupImage.webappAdminPortal01,
          alt: 'Concept mockup for an admin dashboard with revenue charts, lead sources, and team workload',
          previewTitle: 'Admin Portal Concept',
          previewType: 'Admin / Analytics / Management',
        },
        {
          src: mockupImage.webappAdminPortal02,
          alt: 'Concept mockup for an admin dashboard with lead pipeline, project status, and team performance',
          previewTitle: 'Admin Management Dashboard Concept',
          previewType: 'Admin / Analytics / Management',
        },
      ],
    },
  ...
  [
    {
      ...
      images: [
        {
          src: mockupImage.trackerProject01,
          alt: 'Concept mockup for a project tracking dashboard with task tracking, milestones, and team activity',
          previewTitle: 'Project Tracker Concept',
          previewType: 'Progress / Tasks / Updates',
        },
        {
          src: mockupImage.trackerProject02,
          alt: 'Concept mockup for a project tracking dashboard with a project timeline and team progress',
          previewTitle: 'Project Management Dashboard Concept',
          previewType: 'Progress / Tasks / Updates',
        },
      ],
    },
    {
      ...
      images: [
        {
          src: mockupImage.trackerClientPortal01,
          alt: 'Concept mockup for a client portal with milestone progress, file uploads, and feedback',
          previewTitle: 'Client Portal Concept',
          previewType: 'Messages / Files / Reviews / Payments',
        },
        {
          src: mockupImage.trackerClientPortal02,
          alt: 'Concept mockup for a client portal with project progress, files, tasks, and messages',
          previewTitle: 'Client Workspace Concept',
          previewType: 'Messages / Files / Reviews / Payments',
        },
      ],
    },
    {
      ...
      images: [
        {
          src: mockupImage.trackerAuthorPortal01,
          alt: 'Concept mockup for an author portal with book progress, events, and reader messages',
          previewTitle: 'Author Portal Concept',
          previewType: 'Manuscripts / Events / Readers',
        },
        {
          src: mockupImage.trackerAuthorPortal02,
          alt: 'Concept mockup for an author portal with manuscript progress, launch planning, and sales snapshots',
          previewTitle: 'Author Dashboard Concept',
          previewType: 'Manuscripts / Events / Readers',
        },
      ],
    },
    {
      ...
      images: [
        {
          src: mockupImage.trackerProgressDashboard01,
          alt: 'Concept mockup for a progress dashboard with goals, milestones, and team activity',
          previewTitle: 'Progress Dashboard Concept',
          previewType: 'Milestones / Progress / Updates',
        },
        {
          src: mockupImage.trackerProgressDashboard02,
          alt: 'Concept mockup for a progress dashboard with goal tracking and performance overview',
          previewTitle: 'Project Progress Concept',
          previewType: 'Milestones / Progress / Updates',
        },
      ],
    },
