...
export function VisitorCounter() {
  ...
  return (
    <div ref={containerRef} className="pointer-events-none fixed right-4 bottom-4 z-40 flex flex-col items-end">
      ...
      <button
        ...
        className="pointer-events-auto flex items-center gap-2 rounded-md bg-[#102A43] px-4 py-2.5 text-sm font-medium text-white shadow-[0_8px_20px_rgba(16,42,67,0.35)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#0d2238] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
      >
